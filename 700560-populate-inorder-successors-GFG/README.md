# [Populate Inorder Successors](https://www.geeksforgeeks.org/problems/populate-inorder-successor-for-all-nodes/1)
## Medium
...
&nbsp;     /  
&nbsp;    2    / 3  
Output: 3-&gt;2 2-&gt;1 1-&gt;-1Explanation: The inorder of the above tree is: 3 2 1. So the next pointer of node 3 is pointing to 2 , next pointer of 2 is pointing to 1. And next pointer of 1 is pointing to -1 as there is no inorder successor of 1.
Constraints:1&lt;= no. of nodes &lt;=1051&lt;= data of the node &lt;=105